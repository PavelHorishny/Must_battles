...
public class PanelsConstrains {
    ...
    public static final Settings LOG_AREA_SETTINGS = Settings.builder().name("LOG_AREA").background(Color.DARK_GRAY).preferredSize(new Dimension(260,20)).build();
    public static final Settings WIND_ROSE_AREA_SETTINGS = Settings.builder().name("WIND_ROSE_AREA").background(Color.ORANGE).preferredSize(new Dimension(260,260)).layout(new GridBagLayout()).build();
    public static final Settings BUTTON_AREA_SETTINGS = Settings.builder().name("BUTTON_AREA").background(Color.CYAN).preferredSize(new Dimension(260,280)).build();
    public static final Settings GAME_AREA_SETTINGS = Settings.builder().name("GAME_AREA").background(Color.BLUE).preferredSize(new Dimension(1020,960)).build();
    public static final Settings INFO_AREA_SETTINGS = Settings.builder().name("INFO_AREA").background(Color.RED).preferredSize(new Dimension(260,400)).build();
    ...
    public static final Dimension LABEL_SIZE = new Dimension(52,52);
}
